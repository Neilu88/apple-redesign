  ...
  return (
    <div>
      ...
      <section className="!order-2 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
        ...
        <Link href="/">
            <div className="relative ml-14 h-24 w-12 cursor-pointer lg:inline-flex transition hidden">
                <Image
                    src="https://rb.gy/vsvv2o"
                    fill={true}
                    className="object-contain"
        ...
        <div className= "my-4 space-y-2 rounded-md mx-4 border border-gray-300 p-4 lg:ml-14">
            <p>Order updates</p>
        ...
        {mounted && (
            <section className="lg:col-span-4 lg:h-screen lg:border-y-0 lg:overflow-y-scroll border-y border-l border-gray-300 bg-[#fafafa] lg:!order-2">
                        ...
                        <div className="space-y-4 pb-4">
                            {products.map((product) => (
                                <div key={product.id} className="flex items-center space-x-4 text-sm font-medium">
                                    <div className="text-xs text-white relative flex h-16 w-16 items-center justify-center rounded-md border border-gray-300 bg-[#f1f1f1] ">
                                        <div className="relative h-7 w-7 animate-bounce rounded-md">
                                            <Image src="https://rb.gy/vsvv2o" alt="logo" fill={true} className="object-contain"/>
                                        </div>
                                        <div className="absolute -right-2 -top-2 flex h-5 w-5 items-center bg-[gray] justify-center rounded-full text-xs">
                                        {product.quantity}
                                        </div>
                                    </div>
